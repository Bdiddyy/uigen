  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full px-4 text-center">
        <div className="flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-700 mb-5 shadow-lg shadow-blue-200">
          <Sparkles className="h-7 w-7 text-white" />
        </div>
        <p className="text-neutral-900 font-semibold text-xl mb-2">Generate React components</p>
        <p className="text-neutral-400 text-sm max-w-xs leading-relaxed">Describe a component and I'll build it with live preview</p>
      </div>
    );
  }
          ...
          >
            {message.role === "assistant" && (
              <div className="flex-shrink-0 mb-1">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-neutral-100 to-neutral-200 border border-neutral-200 shadow-sm flex items-center justify-center">
